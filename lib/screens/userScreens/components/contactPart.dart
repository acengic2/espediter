...
class ContactPart extends StatefulWidget {
  ...
  ContactPart({this.post, this.userID});

  @override
  _ContactPartState createState() =>
      _ContactPartState(post: post, userID: userID);
}
...
class _ContactPartState extends State<ContactPart> {
  ...
  Widget build(BuildContext context) {
    companyID = widget.post.data['user_id'];
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.hasData) {
            ...
            print('NEMA DATEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE');
            return SizedBox();
          }
        },
      ),
